			...
			<div class="card-header pb-4">
				<div class="row">
					<div class="col-6 d-flex align-items-center">
						<h6 class="mb-0">DAFTAR BENEFIT</h6>
					</div>
					<div class="col-6 text-end">
						<button class="btn bg-gradient-dark mb-0" data-bs-toggle="modal" data-bs-target="#tambahBenefit">
							<i class="fas fa-plus" aria-hidden="true"></i>
							<span class="ms-lg-2 ms-0 d-lg-inline d-none">Benefit</span>
						</button>
					</div>
				</div>
			</div>
					...
					<table class="table align-items-center mb-0 display" id="example" style="width:100%">
						<thead class="bg-light opacity-5">
							<tr>
								...
								<th class="text-uppercase text-dark text-xxs font-weight-bolder opacity-10">Benefit</th>
						...
						<tbody>
						<?php if($benefit->num_rows() > 0): ?>
							<?php $no=1 ;foreach($benefit->result() as $row){ ?>
								...
								<td class="align-top">
									<div class="d-flex px-2 py-1">
										<div class="d-lg-inline d-none">
											<img src="<?= base_url('uploads/benefit/' . $row->img) ?>" class="avatar avatar-lg me-3" alt="user1" style="object-fit: cover;">
										</div>
...
<!-- Modal Tambah Banner -->
<div class="modal fade" id="tambahBenefit" tabindex="-1" aria-labelledby="tambahBenefit" aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				<h6 class="modal-title" id="tambahBenefit">TAMBAH BENEFIT</h6>
				<button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
			</div>
			<form action="<?= site_url('admin/benefit/create') ?>" enctype="multipart/form-data" method="post">
					...
					<div class="row">
						...
						<div class="col-lg-12">
							<div class="form-group mb-2">
								...
								<input type="text" name="deskripsi" class="form-control" placeholder="Tulis nama patner" value="" required="">
							</div>
						</div>
						<div class="col-lg-12">
							<div class="form-group mb-2">
