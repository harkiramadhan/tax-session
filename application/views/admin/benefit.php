				...
				<div class="card-header pb-4">
					<div class="row">
						<div class="col-6 d-flex align-items-center">
							<h6 class="mb-0">DAFTAR BENEFIT AKTIF (MAX 3)</h6>
						</div>
								...
								<tr>
									...
									<td class="align-top">
										<div class="ms-auto text-center">
											...
											<button class="btn btn-link btn-sm py-0 text-dark px-2 mb-0" data-bs-toggle="modal" data-bs-target="#tambahBenefit"><i class="fas fa-pencil-alt" aria-hidden="true"></i></a>
										</div>
									</td>
								</tr>
							</tbody>
