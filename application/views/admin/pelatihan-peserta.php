                                ...
                                <div class="col-12">
                                    <div class="d-flex ps-3 pe-2 py-2 border rounded-3 justify-content-between">
                                        <div class="d-flex flex-column justify-content-center">
                                            ...
                                            <div class="d-flex">
                                                <h6 class="mb-2 font-weight-normal wrap-table-argon">Tingkatkan keterampilan dan karier mu! Menjadi generasi unggul bagi bangsa</h6>
                                        ...
                                        <div class="ml-auto d-lg-inline d-none">
                                            <img src="https://www.smartpassiveincome.com/wp-content/uploads/2020/04/How-to-Create-an-Online-Course.png" class="border rounded-2" alt="user1" style="height: 80px; width: auto;">
                                        </div>
                                    </div>
                                </div>
                            </div>
