			...
			<div class="card-header pb-4">
				<div class="row">
					...
					<div class="col-6 text-end">
						<button class="btn bg-gradient-dark mb-0" data-bs-toggle="modal" data-bs-target="#tambahPartner">
							<i class="fas fa-plus" aria-hidden="true"></i>
							<span class="ms-lg-2 ms-0 d-lg-inline d-none">Partner</span>
						</button>
					</div>
				</div>
			</div>
										...
										<td class="align-top">
											<div class="d-flex px-2 py-1">
												<div class="d-lg-inline d-none">
													<img src="<?= base_url('uploads/partner/' . $row->img) ?>" class="avatar avatar-lg me-3" alt="user1" style="object-fit: cover;">
												</div>
...
<!-- Modal Tambah Banner -->
<div class="modal fade" id="tambahPartner" tabindex="-1" aria-labelledby="tambahPartner" aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				<h6 class="modal-title" id="tambahPartner">TAMBAH Partner</h6>
					...
					<div class="row">
						...
						<div class="col-lg-12">
							<div class="form-group mb-2">
								...
								<input type="text" name="judul" class="form-control" placeholder="Tulis nama Partner" value="" required="">
							</div>
						</div>
						<div class="col-lg-12">
							<div class="form-group mb-2">
