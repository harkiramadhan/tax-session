								...
								<tr>
									...
									<td class="align-top">
										<div class="ms-auto text-center">
											...
											<button class="btn btn-link btn-sm py-0 text-dark px-2 mb-0" data-bs-toggle="modal" data-bs-target="#tambahBanner"><i class="fas fa-pencil-alt" aria-hidden="true"></i></a>
										</div>
									</td>
								</tr>
							</tbody>
