				...
				<div class="row">
					...
					<div class="col-6 text-end">
						<button class="btn bg-gradient-dark mb-0" data-bs-toggle="modal" data-bs-target="#tambahTestimoni">
							...
							<span class="ms-lg-2 ms-0 d-lg-inline d-none">Testimoni</span>
						</button>
					</div>
				</div>
			</div>
									...
									<td class="align-top">
										<div class="d-flex px-2 py-1">
											<div class="d-lg-inline d-none">
												<img src="<?= base_url('uploads/testimoni/' . $row->img) ?>" class="avatar avatar-lg me-3" alt="user1" style="object-fit: cover;">
											</div>
											<div class="d-flex flex-column justify-content-center">
												<h6 class="mb-0 text-sm wrap-table-argon"><?= $row->nama ?></h6>
												<span class="text-dark text-sm"><?= $row->jabatan ?></span>
											</div>
										</div>
									</td>
...
<div class="modal fade" id="tambahTestimoni" tabindex="-1" aria-labelledby="tambahTestimoni" aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<form action="<?= site_url('admin/testimoni/create') ?>" enctype="multipart/form-data" method="POST">
				<div class="modal-body bg-gray-100">
					...
					<div class="col-lg-12">
						<div class="form-group mb-2">
							...
							<input type="text" name="nama" class="form-control" placeholder="Tulis nama patner" value="" required="">
						</div>
					</div>
					<div class="col-lg-12">
						<div class="form-group mb-2">
